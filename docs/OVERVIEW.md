...
Benthium is intended as an operational platform, not only an admin interface.
...
- Nuxt frontend for operational and dashboard workflows
- Laravel backend for modular business services and APIs
